    ...
    <div className="p-5 rounded-md shadow-xl bg-white border border-gray-100">
      ...
      <div className="flex items-center gap-2 my-2">
        <Button className="p-6" variant="outline" size="icon">
          <Avatar>
            <AvatarImage
              src="https://th.bing.com/th?id=OIP.ntWij_8IZKqCcXwHeegmaQAAAA&w=212&h=212&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2"
              // {job?.company?.logo}
            />
          </Avatar>
        </Button>
      ...
      <div className="flex items-center gap-4 mt-4">
        ...
        <Button className="bg-red-700 ">Save For Later</Button>
      </div>
    </div>
  );
};
